...
function SettingsEditor() {
  ...
  const tasksPerPage = (number) =>{
    if(number > 0){
      context.setPerScreen(number)
    }else{
      context.setPerScreen(1)
    }
  }
          ...
          <Card.Body>
            <Form>
              ...
              <Form.Group controlId="perPage">
                ...
                <Form.Control type="number" placeholder={context.perScreen} onChange={(e) => tasksPerPage(e.target.value)} />
              </Form.Group>
